...
function draw_sinus(ctx, Rr, R, ph1) {
    ...
    ph = 360;
    document.getElementById("txt_deg").innerHTML = "phi = " + ph2 + "˚";
	...
	ctx.strokeText("t", Xgrad, 4 * gradLen);
    ...
    if (tension_YN) {
        document.getElementById("txt_ph1").innerHTML = "U = " + -(326 * Ysin).toPrecision(3)+ "V";
    } else {
        document.getElementById("txt_ph1").innerHTML = "ph1=" + -(Ysin).toPrecision(3);
    }
    ctx.fill();
    // draw_sin cos lines
    if (lines_YN) {
    ...
    if (!monophase_YN) {
        ...
        if (tension_YN) {
            document.getElementById("txt_ph3").innerHTML = "ph3=" + -(326 * Ysin).toPrecision(3)+ "V";
        } else {
            document.getElementById("txt_ph3").innerHTML = "ph3=" + -(Ysin).toPrecision(3);
        }
        ctx.fill();
        // draw_sin cos lines
        if (lines_YN) {
        ...
        if (tension_YN) {
             document.getElementById("txt_ph2").innerHTML = "ph2=" + -(326 * Ysin).toPrecision(3)+ "V";
        } else {
           document.getElementById("txt_ph2").innerHTML = "ph2=" + -(Ysin).toPrecision(3);
        }
        ctx.fill();
        // draw_sin cos lines
        if (lines_YN) {
